...
{
    public class Button : Control, IHasText, IUpdateBlocks
    {
        public Button(int rawStartIndex, string rawValue, Global.ArgumentInfoCollection contentArguments, ControlSettings settings) :
        ...
        public override IControl Clone() =>
            new Button(this.RawStartIndex, this.RawValue, this.ContentArguments, this.Settings);
