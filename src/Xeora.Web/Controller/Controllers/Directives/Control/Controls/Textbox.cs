...
{
    public class Textbox : Control, IHasText, IHasDefaultButton, IUpdateBlocks
    {
        public Textbox(int rawStartIndex, string rawValue, Global.ArgumentInfoCollection contentArguments, ControlSettings settings) :
        ...
        public override IControl Clone() =>
            new Textbox(this.RawStartIndex, this.RawValue, this.ContentArguments, this.Settings);
